...
✅ Brain updated:
  ...
  - Updated Tasks/doing-short-action.md (+1 row)
...
| Long-term ambiguous task | `Tasks/doing-long-ambiguous.md` |
| Long-term structured task | `Tasks/doing-long-structured.md` |
| Short actionable task | `Tasks/doing-short-action.md` |
| Completed long-term ambiguous task | `Tasks/done-long-ambiguous.md` |
| Completed long-term structured task | `Tasks/done-long-structured.md` |
| Completed short actionable task | `Tasks/done-short-action.md` |
...
After routing a task to the correct `Tasks/*.md` file, append one row to the existing table in that file.
Do not write tasks back into the legacy `Tasks/tasks.md` structure.
If important columns are unclear (for example task type, tag, priority, status, summary, description, refs, or whether it belongs under a sub task), ask the user instead of guessing.
